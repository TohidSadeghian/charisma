...
from orders.api.urls import router as orders_router
from products.api.urls import router as products_router
from invoices.api.urls import router as invoices_router


router = DefaultRouter()
router.registry.extend(orders_router.registry)
router.registry.extend(products_router.registry)
router.registry.extend(invoices_router.registry)
